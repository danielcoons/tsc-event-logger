...
<Project Type="Project" LVVersion="19008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="_Unit Test" Type="Folder">
			...
			<Item Name="Test-Encryption.lvclass" Type="LVClass" URL="../_Unit Tests/Test-Encryption/Test-Encryption.lvclass"/>
			<Item Name="Test-File IO.lvclass" Type="LVClass" URL="../_Unit Tests/Test-File IO/Test-File IO.lvclass"/>
			<Item Name="Test-Layout (JSON).lvclass" Type="LVClass" URL="../_Unit Tests/Layout/Test-Layout (JSON)/Test-Layout (JSON).lvclass"/>
			<Item Name="Test-Layout.lvclass" Type="LVClass" URL="../_Unit Tests/Layout/Test-Layout.lvclass"/>
		</Item>
		<Item Name="Example" Type="Folder">
			...
			<Item Name="Simple Example.vi" Type="VI" URL="../Example/Simple Example.vi"/>
			<Item Name="Database Example.vi" Type="VI" URL="../Example/Database Example.vi"/>
			<Item Name="Simple Example Binary.vi" Type="VI" URL="../Example/Simple Example Binary.vi"/>
			<Item Name="Console with Filter.vi" Type="VI" URL="../Example/Console with Filter.vi"/>
		</Item>
		<Item Name="TSC Event Logger.lvlib" Type="Library" URL="../TSC Event Logger.lvlib"/>
